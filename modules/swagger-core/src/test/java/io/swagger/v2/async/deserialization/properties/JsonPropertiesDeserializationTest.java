package io.swagger.v2.async.deserialization.properties;
...
public class JsonPropertiesDeserializationTest {
    ...
    public void testDeserializeConstrainedStringProperty() throws Exception {
        ...
        AsyncAPI oas = TestUtils.deserializeJsonFileFromClasspath("specFiles/propertiesWithConstraints.json", AsyncAPI.class);
    ...
    public void testDeserializePropertyWithVendorExtensions() throws Exception {
        ...
        AsyncAPI oas = TestUtils.deserializeJsonFileFromClasspath("specFiles/propertyWithVendorExtensions.json", AsyncAPI.class);
