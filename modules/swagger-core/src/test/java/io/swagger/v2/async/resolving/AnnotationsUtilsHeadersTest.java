...
import io.swagger.v2.aas.models.headers.Header.StyleEnum;
...
public class AnnotationsUtilsHeadersTest {
    ...
    private io.swagger.v2.aas.models.headers.Header header() {
        return new io.swagger.v2.aas.models.headers.Header().style(StyleEnum.SIMPLE);
    }
    ...
    public void extensionsTest(String methodName,
                               Optional<Map<String, io.swagger.v2.aas.models.headers.Header>> expected)
        ...
        final Optional<Map<String, io.swagger.v2.aas.models.headers.Header>> optionalMap =
