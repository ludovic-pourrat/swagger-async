...
import io.swagger.v2.async.jackson.AbstractModelConverter;
...
public class ModelWithTuple2 {
    @io.swagger.v2.aas.annotations.media.Schema(description = "Possible values for state property of timesheet or timesheet entry", required = true)
    public Pair<String, String> timesheetStates;

    @io.swagger.v2.aas.annotations.media.Schema(description = "set of pairs", required = true)
    public Set<Pair<String, String>> manyPairs;

    @io.swagger.v2.aas.annotations.media.Schema(description = "set of pairs with complex left", required = true)
