...
public class PojoTest {
    ...
    private Map<String, io.swagger.v2.aas.models.media.Schema> read(Type type) {
        return ModelConverters.getInstance().read(type);
    }

    private Map<String, io.swagger.v2.aas.models.media.Schema> readAll(Type type) {
    ...
    public void testModelWithMultipleRepresentations() {
        ...
        final Map<String, io.swagger.v2.aas.models.media.Schema> schemas = readAll(UberObject.class);
    ...
    public void testExcludeSchema() {
        ...
        String yamlUser = "type: object\n" +
                ...
                "    description: 'A valid user social security'\n" +
                "    pattern: '^\\d{3}-?\\d{2}-?\\d{4}$'";
        Map<String, io.swagger.v2.aas.models.media.Schema> map = readAll(ArbitraryDataReceiver.class);
    ...
    public void testExampleArray() {
        ...
        String yaml =
                "modelExampleArray:\n" +
                        ...
                        "      items:\n" +
                        "        type: string";
        Map<String, io.swagger.v2.aas.models.media.Schema> schemaMap = readAll(modelExampleArray.class);
