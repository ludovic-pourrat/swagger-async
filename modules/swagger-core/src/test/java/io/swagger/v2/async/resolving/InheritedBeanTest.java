...
public class InheritedBeanTest extends SwaggerTestBase {
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "BaseBean"
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "Sub1Bean", allOf = {BaseBean.class})
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "BaseBean2"
//            , discriminator = "type", subTypes = {Sub1Bean.class}
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "Sub2Bean", allOf = {BaseBean2.class}, anyOf = {BaseBean.class})
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "BaseBean3"
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "ChildBean3", allOf = {BaseBean3.class})
    static class ChildBean3 extends BaseBean3 {
        public int c;
    }

    @io.swagger.v2.aas.annotations.media.Schema(description = "GrandChildBean3", allOf = {ChildBean3.class})
    static class GrandChildBean3 extends ChildBean3 {
        public int d;
    }

    @io.swagger.v2.aas.annotations.media.Schema(anyOf = {UserObject.class, EmployeeObject.class})
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "A User Object")
    interface UserObject {
        @io.swagger.v2.aas.annotations.media.Schema(format = "uuid", required = true)
        String getId();

        String getName();
    }

    @io.swagger.v2.aas.annotations.media.Schema(description = "An Employee Object", requiredProperties = {"department"})
    interface EmployeeObject {
        @io.swagger.v2.aas.annotations.media.Schema(format = "email")
        String getId();
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "MultipleBaseBean"
//            , discriminator = "type", subTypes = {MultipleSub1Bean.class, MultipleSub2Bean.class}
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "MultipleSub1Bean", allOf = {MultipleBaseBean.class})
    static class MultipleSub1Bean extends MultipleBaseBean {
        public int c;
    }

    @io.swagger.v2.aas.annotations.media.Schema(description = "MultipleSub2Bean", allOf = {MultipleBaseBean.class})
