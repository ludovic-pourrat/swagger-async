...
import io.swagger.v2.aas.models.parameters.HeaderParameter;
import io.swagger.v2.aas.models.parameters.Parameter;
import io.swagger.v2.aas.models.parameters.PathParameter;
...
public class ParameterSerializationTest {
    ...
    public void testIssue1765() throws Exception {
        ...
        AsyncAPI swagger = Yaml.mapper().readValue(yaml, AsyncAPI.class);
