...
public class Ticket3063Test extends SwaggerTestBase {
    ...
    @io.swagger.v2.aas.annotations.media.Schema(description = "SubClass")
    public class SubClass extends BaseClass {
        @io.swagger.v2.aas.annotations.media.Schema(required = false, description = "Test")
        public int additionalPropertyWhichShouldBeThere = -1;

    }

    @io.swagger.v2.aas.annotations.media.Schema(description = "test", discriminatorProperty="type")
    @JsonTypeInfo(
    ...
    public class BaseClass {
        ...
        @io.swagger.v2.aas.annotations.media.Schema(required = true, description = "Type", example="AndroidDeviceRequirements")
        public String type;
