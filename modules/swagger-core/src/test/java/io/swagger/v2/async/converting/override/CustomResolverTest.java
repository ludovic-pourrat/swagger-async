...
import io.swagger.v2.async.jackson.TypeNameResolver;
...
public class CustomResolverTest {
    ...
    class QualifiedTypeNameResolver extends TypeNameResolver {
        ...
        protected String nameForClass(Class<?> cls, Set<Options> options) {
            ...
            final io.swagger.v2.aas.annotations.media.Schema model = cls.getAnnotation(io.swagger.v2.aas.annotations.media.Schema.class);
