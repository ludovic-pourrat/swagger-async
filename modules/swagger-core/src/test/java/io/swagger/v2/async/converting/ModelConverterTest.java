...
import io.swagger.v2.async.oas.models.Cat;
import io.swagger.v2.async.oas.models.ClientOptInput;
import io.swagger.v2.async.oas.models.Employee;
import io.swagger.v2.async.oas.models.EmptyModel;
import io.swagger.v2.async.oas.models.JacksonReadonlyModel;
import io.swagger.v2.async.oas.models.JodaDateTimeModel;
import io.swagger.v2.async.oas.models.Model1155;
import io.swagger.v2.async.oas.models.ModelPropertyName;
import io.swagger.v2.async.oas.models.ModelWithAltPropertyName;
import io.swagger.v2.async.oas.models.ModelWithApiModel;
import io.swagger.v2.async.oas.models.ModelWithEnumArray;
import io.swagger.v2.async.oas.models.ModelWithFormattedStrings;
import io.swagger.v2.async.oas.models.ModelWithNumbers;
import io.swagger.v2.async.oas.models.ModelWithOffset;
import io.swagger.v2.async.oas.models.ModelWithTuple2;
import io.swagger.v2.async.oas.models.Person;
import io.swagger.v2.async.oas.models.composition.AbstractModelWithApiModel;
import io.swagger.v2.async.oas.models.composition.ModelWithUrlProperty;
