...
public class AnnotationsUtilsTest {
    ...
    @ApiResponse(content = @Content(schema = @io.swagger.v2.aas.annotations.media.Schema(implementation = Byte.class)))
    private void byteType() {
    }

    @ApiResponse(content = @Content(schema = @io.swagger.v2.aas.annotations.media.Schema(implementation = Byte.class, format = "binary")))
    private void binaryType() {
    }

    @ApiResponse(content = @Content(schema = @io.swagger.v2.aas.annotations.media.Schema(implementation = String.class, format = "email")))
    private void emailType() {
    }

    @ApiResponse(content = @Content(schema = @io.swagger.v2.aas.annotations.media.Schema(implementation = DummyClass.class)))
