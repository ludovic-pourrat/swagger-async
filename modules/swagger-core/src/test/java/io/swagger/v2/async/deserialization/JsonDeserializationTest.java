package io.swagger.v2.async.deserialization;
...
import io.swagger.v2.async.util.TestUtils;
...
public class JsonDeserializationTest {
    ...
    public void testPetstore() throws IOException {
        ...
        final Object swagger = m.readValue(json, AsyncAPI.class);
        assertTrue(swagger instanceof AsyncAPI);
    }
    ...
    public void testCompositionTest() throws IOException {
        ...
        final Object deserialized = m.readValue(json, AsyncAPI.class);
        assertTrue(deserialized instanceof AsyncAPI);
        AsyncAPI asyncAPI = (AsyncAPI) deserialized;
        Schema lizardSchema = asyncAPI.getComponents().getSchemas().get("Lizard");
        assertTrue(lizardSchema instanceof ComposedSchema);
        assertEquals(((ComposedSchema) lizardSchema).getAllOf().size(), 2);

        Schema petSchema = asyncAPI.getComponents().getSchemas().get("Pet");
    ...
    public void testDeserializePetStoreFile() throws Exception {
        TestUtils.deserializeJsonFileFromClasspath("specFiles/petstore.json", AsyncAPI.class);
    }

    @Test
    public void testDeserializeCompositionTest() throws Exception {
        TestUtils.deserializeJsonFileFromClasspath("specFiles/compositionTest.json", AsyncAPI.class);
    }

    @Test
    public void testDeserializeAPathRef() throws Exception {
        final AsyncAPI oas = TestUtils.deserializeJsonFileFromClasspath("specFiles/pathRef.json", AsyncAPI.class);
    ...
    public void testDeserializeAResponseRef() throws Exception {
        final AsyncAPI oas = TestUtils.deserializeJsonFileFromClasspath("specFiles/responseRef.json", AsyncAPI.class);
    ...
    public void testDeserializeSecurity() throws Exception {
        final AsyncAPI swagger = TestUtils.deserializeJsonFileFromClasspath("specFiles/securityDefinitions.json", AsyncAPI.class);
    ...
    public void deserializeLongSchema() throws IOException {
        ...
        final AsyncAPI swagger = Yaml.mapper().readValue(jsonString, AsyncAPI.class);
    ...
    public void testDeserializeRefCallback() throws Exception {
        ...
        AsyncAPI oas = Yaml.mapper().readValue(yaml, AsyncAPI.class);
    ...
    public void testNullEnumItem() throws Exception {
        ...
        oas = Yaml.mapper().readValue(yaml, AsyncAPI.class);
    ...
    public void testNullExampleDeserialization() throws Exception {
        ...
        AsyncAPI oas = Yaml.mapper().readValue(yamlNull, AsyncAPI.class);
        ...
        oas = Yaml.mapper().readValue(yamlMissing, AsyncAPI.class);
        Yaml.prettyPrint(oas);
        assertNull(oas.getComponents().getSchemas().get("UserStatus").getExample());
