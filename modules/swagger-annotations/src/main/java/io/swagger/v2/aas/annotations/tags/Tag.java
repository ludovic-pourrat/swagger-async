package io.swagger.v2.aas.annotations.tags;
...
import io.swagger.v2.aas.annotations.ExternalDocumentation;
...
/**
 * The annotation may be applied at class or method level, or in {@link Operation#tags()} to define tags for the
 * single operation (when applied at method level) or for all operations of a class (when applied at class level).
 * <p>It can also be used in {@link AsyncAPIDefinition#tags()} to define spec level tags.</p>
